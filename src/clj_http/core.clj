(ns clj-http.core
  ...
  (:import (org.apache.http.client.methods HttpGet HttpHead HttpPut HttpPost HttpDelete HttpPatch))
...
(defn request
  ...
  [{:keys [request-method url scheme server-name server-port uri query-string
           headers content-type character-encoding body log-url]}]
